...
Alchemy billing mode setup in watcher:
- set `COMPUTE_BILLING_MODE=alchemy`
- set `ALCHEMY_API_BASE_URL`
- set `ALCHEMY_PAYER_ADDRESS`
- optional: `ALCHEMY_API_KEY`, `ALCHEMY_CREDITS_BALANCE_PATH`, `ALCHEMY_FALLBACK_TO_ESCROW_ON_ERROR`
